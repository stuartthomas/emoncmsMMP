...
<html>
    <head>
		...
		<link rel="stylesheet" href="<?php echo $path; ?>fullcalendar/fullcalendar.css" />
		<script type="text/javascript" src="<?php echo $path; ?>fullcalendar/lib/jquery.min.js"></script>
		<script type="text/javascript" src="<?php echo $path; ?>fullcalendar/lib/moment.min.js"></script>
		<script type="text/javascript" src="<?php echo $path; ?>fullcalendar/fullcalendar.js"></script>
        <script type="text/javascript" src="<?php echo $path; ?>Lib/jquery-1.9.0.min.js"></script>
		<script type="text/javascript" src="<?php echo $path; ?>fullcalendar/fcalendar.js"></script>
    </head>
