...
else if($res=="privileged"){
echo "user is privileged";
}
else{
echo "user is normal";
}
...
<div class="row">
    ...
    <div class="span4">
        ...
        <div id="account">
			...
			<div class="account-item">
                <span class="muted"><?php echo _('Usertype'); ?></span>
                <span><br><?php echo $res; ?><br></span>
                <div id="edit-email-form" class="input-append" style="display:none">
                    <input class="span2" type="text" style="width:150px">
                    <button class="btn" type="button"><?php echo _('Save'); ?></button>
                </div>
...
<script>
    ...
    list.fields = {
		...
		//'usertype':{'title':"<?php echo _('Usertype'); ?>", 'type':'text'}
